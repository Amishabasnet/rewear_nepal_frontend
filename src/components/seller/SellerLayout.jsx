...
import { LayoutDashboard, Package, ShoppingBag, PlusCircle, Shirt } from "lucide-react";
      ...
      <aside className="lg:sticky lg:top-8 lg:h-fit">
        <div className="mb-4 flex items-center gap-3 rounded-xl border border-ink-100 bg-white p-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-ink-900">{user?.name || "Your listings"}</p>
            <p className="text-xs text-ink-400">Selling on ReWear Nepal</p>
          </div>
        </div>
